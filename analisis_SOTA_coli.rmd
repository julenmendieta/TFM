...
# Enriquecimineto GO
enriquecimientoGO <- function(listaGenes, semData) {
    # Cambiamos los IDs a entrez
    ...
    for(ont in ontologies) {
        ...
        if(dim(result)[1] != 0) {
            ...
            resultsalida = simplificar(resultsalida, ont, cutoff=0.7, by="FDR", 
                                     select_fun=min, measure="Rel", organismo = "ecolik12", semData=semData)
...
semDataBP <- godata('org.EcK12.eg.db', ont="BP")
semDataCC <- godata('org.EcK12.eg.db', ont="CC")
