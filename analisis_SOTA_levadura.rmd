...
SOTA <- function(Matriz_6, ciclos, escala) {
...
global_SOTA <- function(Matriz_6, clusters_test = "inicio", reanalizar = "inicio", s.sota = 0, escala, clu_comp = "", fin="", nodos=c(), record_silueta = "Silueta") {
  if(clu_comp != "") {
...
escala = nrow(Matriz_6) / 18

arbol = global_SOTA(Matriz_6, escala = escala, fin=fin)
```
