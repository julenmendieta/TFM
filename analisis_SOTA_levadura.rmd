...
plotear <- function(DatosFilt, clu, clu_comp, ran1 = -0.1, ran2 = 1.1, go = TRUE, seguir = TRUE) {
  eje = 2
...
# Funcion para reducir el numero de GOs que aparecen
# Funcion para eliinar GO solapantes
